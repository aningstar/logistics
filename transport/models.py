...
class driver(models.Model):
	...
	dr_q1 = models.CharField(max_length=200,verbose_name='问题1')
	dr_a1 = models.CharField(max_length=200,verbose_name='答案1')
	dr_q2 = models.CharField(max_length=200,verbose_name='问题2')
...
class order(models.Model):
	...
	or_price_unit = models.CharField(max_length=20,verbose_name="总价值单位")
	...
	or_weight_unit = models.CharField(max_length=20,verbose_name="总重单位")
	...
	or_request = models.CharField(max_length=500,verbose_name='其他说明',null=True,blank=True)
	#0 推送中的订单 1 进行中的订单 2 已完成的订单 3 关闭的订单 4 等待司机确认
	...
	or_end_longitude = models.DecimalField(max_digits=15,decimal_places=8,verbose_name='卸货纬度')
	or_end_latitude = models.DecimalField(max_digits=15,decimal_places=8,verbose_name='卸货纬度')
	or_distance = models.DecimalField(max_digits=15,decimal_places=5,verbose_name='运输距离',default=0)
